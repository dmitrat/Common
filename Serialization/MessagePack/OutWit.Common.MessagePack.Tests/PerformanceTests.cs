    ...
    public class PerformanceTests
    {
        ...
        public void BytesSerializationGenericPerformanceTest()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                var jsonBytes = values.ToMessagePackBytes();
                ...
                var values1 = jsonBytes.FromMessagePackBytes<int[]>();
        ...
        public void BytesSerializationTypedPerformanceTest()
        {
            ...
            {
                var start = DateTime.Now;
                var jsonBytes = values.ToMessagePackBytes(typeof(int[]));
                var end = DateTime.Now;
                ...
                var values1 = jsonBytes.FromMessagePackBytes(typeof(int[])) as int[];
        ...
        public void MemoryPackClonePerformanceTest()
        {
            ...
            {
                var start = DateTime.Now;
                var values1 = values.MessagePackClone();
                var end = DateTime.Now;
