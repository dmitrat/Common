...
If you use OutWit.Common.MVVM.Blazor in a product, a mention is appreciated (but not required), for example:
"Powered by OutWit.Common.MVVM.Blazor (https://ratner.io/)".
