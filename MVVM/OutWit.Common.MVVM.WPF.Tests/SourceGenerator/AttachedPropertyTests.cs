...
namespace OutWit.Common.MVVM.WPF.Tests.SourceGenerator
{
    ...
    public class AttachedPropertyTests
    {
        ...
        [Test]
        public void OpacityPropertyHasAffectsRenderMetadataTest()
        {
            var opacityProperty = (DependencyProperty)typeof(TestAttachedProperties)
                .GetField("OpacityProperty", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static)!
                .GetValue(null)!;

            var metadata = opacityProperty.GetMetadata(typeof(DependencyObject)) as FrameworkPropertyMetadata;

            Assert.That(metadata, Is.Not.Null);
            Assert.That(metadata!.AffectsRender, Is.True);
        }
