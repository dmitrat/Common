...
{
    /// <summary>
    /// Aspect that transforms static properties marked with [AttachedProperty] to use DependencyProperty GetValue/SetValue.
    /// Works in conjunction with the source generator that creates the DependencyProperty fields and Get/Set methods.
    /// </summary>
    [Aspect(Scope.Global)]
    public class AttachedPropertyAspect
    {
            ...
            [Argument(Source.Arguments)] object[] args)
        {
            ...
            // Return the default value from the DependencyProperty
