...
using OutWit.Common.MVVM.Avalonia.Generator.Generators;
using System.Linq;
using System.Text;

namespace OutWit.Common.MVVM.Avalonia.Generator
{
    [Generator(LanguageNames.CSharp)]
    public sealed class AvaloniaStyledPropertyGenerator : IIncrementalGenerator
    {
        #region Constants
        ...
        private const string DIRECT_PROPERTY_ATTRIBUTE_NAME = "OutWit.Common.MVVM.Attributes.DirectPropertyAttribute";
        ...
        private static PropertyInfo? GetPropertyInfo(GeneratorSyntaxContext context)
        {
            ...
            var directAttr = attributes.FirstOrDefault(a =>
                a.AttributeClass?.ToDisplayString() == DIRECT_PROPERTY_ATTRIBUTE_NAME);

            if (styledAttr == null && attachedAttr == null && directAttr == null)
                return null;
            ...
            return new PropertyInfo
            {
                ...
                AttributeData = directAttr ?? attachedAttr ?? styledAttr!,
                IsAttached = attachedAttr != null,
                IsDirect = directAttr != null
            };
        }
