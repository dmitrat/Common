...
{
    [TestFixture]
    public class JsonSettingsProviderConcurrencyTests
    {
        #region Fields
        ...
        public void Setup()
        {
            m_testDir = Path.Combine(Path.GetTempPath(), "OutWit.Settings.ConcurrencyTests", Guid.NewGuid().ToString());
  ...
  ""General"": [
    ...
    { ""key"": ""Mode"", ""value"": ""Dark"", ""valueKind"": ""String"" }
  ]
}");
        ...
        {
            var path = Path.Combine(m_testDir, "concurrent-write.json");
            var provider = new JsonSettingsProvider(path);
  ...
  ""General"": [
    { ""key"": ""Name"", ""value"": ""admin"", ""valueKind"": ""String"" }
        ...
        private string WriteJsonFile(string content)
        {
