...
namespace OutWit.Common.MemoryPack.Tests.Values
{
    ...
    public class ValueInSet
    {
        ...
        {
            var value = new MemoryPackValueInSet<int>(1, 1, 2, 3);
        ...
        public void IsTest()
        {
            var value1 = new MemoryPackValueInSet<int>(1, 1, 2, 3);
            var value2 = new MemoryPackValueInSet<int>(1, 1, 2, 3);

            Assert.That(value1.Is(value2), Is.True);

            value2 = new MemoryPackValueInSet<int>(2, 1, 2, 3);
            Assert.That(value1.Is(value2), Is.False);

            value2 = new MemoryPackValueInSet<int>(1, 1, 2);
            Assert.That(value1.Is(value2), Is.False);
        }
        ...
        public void CloneTest()
        {
            ...
            var value2 = value1.Clone() as MemoryPackValueInSet<int>;
        ...
        public void SerializationTest()
        {
            ...
            var value2 = bytes.FromMemoryPackBytes<MemoryPackValueInSet<int>>();
            Assert.That(value2, Is.Not.Null);
