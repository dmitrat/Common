...
namespace OutWit.Common.Logging.NewRelic.Tests
{
    [TestFixture]
    [Explicit]
    public class NewRelicProviderTests
    {
        ...
        public async Task QueryAsyncWithFullParametersSucceedsTest()
        {
            ...
            var query = new LogQuery
            {
                ...
                Filters = new[]
                {
                    LogFilters.LevelAtLeast(LogSeverity.Information)
                },
                PageSize = 25,
                Offset = 0,
        ...
        public async Task QueryWithMultipleFiltersSucceedsTest()
        {
            ...
            var query = new LogQuery
            {
                ...
                Filters = new[]
                {
                    ...
                    LogFilters.MessageContains("exception")
                },
                PageSize = 10
            };
        ...
        public async Task FindOffsetTest()
        {
            ...
            var baseQuery = new LogQuery
            {
                ...
                Filters = new[]
                {
                    LogFilters.LevelEquals(LogSeverity.Information)
                },
                PageSize = 150,
                SortOrder = LogSortOrder.Descending
            };
            ...
            // or just change parameters if LogQuery allows it (you have a Clone method in the model).
        ...
        public async Task GetStatisticsWithFiltersTest()
        {
            ...
            var filters = new List<LogFilter>
            {
                LogFilters.LevelAtLeast(LogSeverity.Warning)
            };
