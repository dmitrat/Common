...
{
    [TestFixture]
    public class FatAllocatorTests
    {
        #region Constants
        ...
        private static async Task<(FatTable Table, FatAllocator Allocator, BlockDeviceProbe Probe)> CreateAsync(FatTableImage image,
            byte[]? sectorZero = null)
        {
            ...
            return (table, new FatAllocator(probe, table), probe);
        }
